...
sleep 60
# Wait for operator
kubectl --context ${CLUSTER1} -n gm-iop-${REVISION} rollout status deploy/istio-operator-${REVISION}
kubectl --context ${CLUSTER2} -n gm-iop-${REVISION} rollout status deploy/istio-operator-${REVISION}
# Wait for istiod
kubectl --context ${CLUSTER1} -n istio-system rollout status deploy/istiod-${REVISION}
kubectl --context ${CLUSTER2} -n istio-system rollout status deploy/istiod-${REVISION}
# Wait for Gateways
sleep 10
kubectl --context ${CLUSTER1} -n istio-gateways rollout status deploy/istio-eastwestgateway-${REVISION}
kubectl --context ${CLUSTER2} -n istio-gateways rollout status deploy/istio-eastwestgateway-${REVISION}
kubectl --context ${CLUSTER1} -n istio-gateways rollout status deploy/istio-ingressgateway-${REVISION}
kubectl --context ${CLUSTER2} -n istio-gateways rollout status deploy/istio-ingressgateway-${REVISION}
